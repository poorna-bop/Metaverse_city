...
public class WebGLSendContractExample : MonoBehaviour
{
    ...
    async public void buyItem()
    {
        string method = "buyItem";
        //string contract = selectedChain;
        string contract = "0xc8caE4392cC4f1Cf1E5477FDf18a10B29f2d9041";
